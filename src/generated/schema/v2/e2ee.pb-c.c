...
void mingdrlms__v2__signal_sender_key_distribution__init(
    ...
    static const Mingdrlms__V2__SignalSenderKeyDistribution init_value =
...
mingdrlms__v2__signal_sender_key_distribution__unpack(
    ProtobufCAllocator *allocator, size_t len, const uint8_t *data) {
    return (Mingdrlms__V2__SignalSenderKeyDistribution *)
...
void mingdrlms__v2__e2_eesender_key_push_request__init(
    ...
    static const Mingdrlms__V2__E2EESenderKeyPushRequest init_value =
        MINGDRLMS__V2__E2_EESENDER_KEY_PUSH_REQUEST__INIT;
    *message = init_value;
}
...
mingdrlms__v2__e2_eesender_key_push_request__unpack(
    ProtobufCAllocator *allocator, size_t len, const uint8_t *data) {
    return (Mingdrlms__V2__E2EESenderKeyPushRequest *)protobuf_c_message_unpack(
        &mingdrlms__v2__e2_eesender_key_push_request__descriptor, allocator,
        len, data);
}
...
void mingdrlms__v2__e2_eesender_key_push_response__init(
    ...
    static const Mingdrlms__V2__E2EESenderKeyPushResponse init_value =
...
mingdrlms__v2__e2_eesender_key_push_response__unpack(
    ProtobufCAllocator *allocator, size_t len, const uint8_t *data) {
    return (Mingdrlms__V2__E2EESenderKeyPushResponse *)
        protobuf_c_message_unpack(
            &mingdrlms__v2__e2_eesender_key_push_response__descriptor,
            allocator, len, data);
}
...
static const ProtobufCFieldDescriptor
    mingdrlms__v2__e2_eegenerate_keys_request__field_descriptors[6] = {
        {
        ...
        {
            "identity_key", 3, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_MESSAGE,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EEGenerateKeysRequest, identity_key),
            &mingdrlms__v2__signal_key_pair__descriptor, NULL, 0, /* flags */
            0, NULL, NULL /* reserved1,reserved2, etc */
        },
        {
            "signed_pre_key", 4, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_MESSAGE,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EEGenerateKeysRequest, signed_pre_key),
            &mingdrlms__v2__signal_signed_pre_key__descriptor, NULL,
            0,            /* flags */
            0, NULL, NULL /* reserved1,reserved2, etc */
        },
        {
            "pre_keys", 5, PROTOBUF_C_LABEL_REPEATED, PROTOBUF_C_TYPE_MESSAGE,
            offsetof(Mingdrlms__V2__E2EEGenerateKeysRequest, n_pre_keys),
            offsetof(Mingdrlms__V2__E2EEGenerateKeysRequest, pre_keys),
            &mingdrlms__v2__signal_pre_key__descriptor, NULL, 0, /* flags */
            0, NULL, NULL /* reserved1,reserved2, etc */
        },
        {
            "pqc_public_key", 9, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_BYTES,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EEGenerateKeysRequest, pqc_public_key),
            NULL, NULL, 0, /* flags */
            0, NULL, NULL  /* reserved1,reserved2, etc */
        },
};
static const unsigned
    mingdrlms__v2__e2_eegenerate_keys_request__field_indices_by_name[] = {
        ...
        5, /* field[5] = pqc_public_key */
        4, /* field[4] = pre_keys */
        3, /* field[3] = signed_pre_key */
        0, /* field[0] = user_name */
};
static const ProtobufCIntRange
    mingdrlms__v2__e2_eegenerate_keys_request__number_ranges[2 + 1] = {{1, 0},
                                                                       {9, 5},
                                                                       {0, 6}};
...
static const ProtobufCFieldDescriptor
    mingdrlms__v2__e2_eegenerate_keys_response__field_descriptors[9] = {
        {
        ...
        },
        {
            "pqc_public_key", 9, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_BYTES,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EEGenerateKeysResponse, pqc_public_key),
            NULL, NULL, 0, /* flags */
            0, NULL, NULL  /* reserved1,reserved2, etc */
        },
};
...
static const ProtobufCFieldDescriptor
    mingdrlms__v2__e2_eepre_key_bundle_response__field_descriptors[11] = {
        {
            "code", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT32,
            0, /* quantifier_offset */
        ...
        {
            "pqc_public_key", 11, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_BYTES,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EEPreKeyBundleResponse, pqc_public_key),
            NULL, NULL, 0, /* flags */
            0, NULL, NULL  /* reserved1,reserved2, etc */
        },
};
...
static const ProtobufCFieldDescriptor
    mingdrlms__v2__signal_sender_key_distribution__field_descriptors[8] = {
        {
            "room_name", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution, room_name),
            NULL, &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                      /* reserved1,reserved2, etc */
        },
        {
            "group_id", 2, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution, group_id),
            NULL, &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                      /* reserved1,reserved2, etc */
        },
        {
            ...
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution, sender), NULL,
            &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                /* reserved1,reserved2, etc */
        },
        {
            ...
            PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution,
                     sender_device_id),
            NULL, NULL, 0, /* flags */
            0, NULL, NULL  /* reserved1,reserved2, etc */
        },
        ...
        {
            "distribution_message", 6, PROTOBUF_C_LABEL_NONE,
            PROTOBUF_C_TYPE_BYTES, 0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution,
        ...
        {
            "sender_key_id", 7, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution, sender_key_id),
            NULL, NULL, 0, /* flags */
            0, NULL, NULL  /* reserved1,reserved2, etc */
        },
        {
            "sender_key_iteration", 8, PROTOBUF_C_LABEL_NONE,
            PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__SignalSenderKeyDistribution,
...
static const unsigned
    mingdrlms__v2__signal_sender_key_distribution__field_indices_by_name[] = {
        5, /* field[5] = distribution_message */
        1, /* field[1] = group_id */
        0, /* field[0] = room_name */
        2, /* field[2] = sender */
        3, /* field[3] = sender_device_id */
        6, /* field[6] = sender_key_id */
        7, /* field[7] = sender_key_iteration */
        4, /* field[4] = sender_registration_id */
};
static const ProtobufCIntRange
    mingdrlms__v2__signal_sender_key_distribution__number_ranges[1 + 1] = {
        {1, 0},
        {0, 8}};
const ProtobufCMessageDescriptor
    mingdrlms__v2__signal_sender_key_distribution__descriptor = {
        PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
        "mingdrlms.v2.SignalSenderKeyDistribution",
        "SignalSenderKeyDistribution",
        "Mingdrlms__V2__SignalSenderKeyDistribution",
        "mingdrlms.v2",
        sizeof(Mingdrlms__V2__SignalSenderKeyDistribution),
        8,
        mingdrlms__v2__signal_sender_key_distribution__field_descriptors,
        mingdrlms__v2__signal_sender_key_distribution__field_indices_by_name,
        1,
        mingdrlms__v2__signal_sender_key_distribution__number_ranges,
...
static const ProtobufCFieldDescriptor
    mingdrlms__v2__e2_eesender_key_push_request__field_descriptors[3] = {
        {
            "access_token", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EESenderKeyPushRequest, access_token),
            NULL, &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                      /* reserved1,reserved2, etc */
        },
        {
            "target_user", 2, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EESenderKeyPushRequest, target_user),
            NULL, &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                      /* reserved1,reserved2, etc */
        },
        {
            "distribution", 3, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_MESSAGE,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EESenderKeyPushRequest, distribution),
            &mingdrlms__v2__signal_sender_key_distribution__descriptor, NULL,
            0,            /* flags */
            0, NULL, NULL /* reserved1,reserved2, etc */
        },
};
static const unsigned
    mingdrlms__v2__e2_eesender_key_push_request__field_indices_by_name[] = {
        0, /* field[0] = access_token */
        2, /* field[2] = distribution */
        1, /* field[1] = target_user */
};
static const ProtobufCIntRange
    mingdrlms__v2__e2_eesender_key_push_request__number_ranges[1 + 1] = {
        {1, 0},
        {0, 3}};
const ProtobufCMessageDescriptor
    mingdrlms__v2__e2_eesender_key_push_request__descriptor = {
        PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
        "mingdrlms.v2.E2EESenderKeyPushRequest",
        "E2EESenderKeyPushRequest",
        "Mingdrlms__V2__E2EESenderKeyPushRequest",
        "mingdrlms.v2",
        sizeof(Mingdrlms__V2__E2EESenderKeyPushRequest),
        3,
        mingdrlms__v2__e2_eesender_key_push_request__field_descriptors,
        mingdrlms__v2__e2_eesender_key_push_request__field_indices_by_name,
        1,
        mingdrlms__v2__e2_eesender_key_push_request__number_ranges,
        (ProtobufCMessageInit)mingdrlms__v2__e2_eesender_key_push_request__init,
        NULL,
        NULL,
        NULL /* reserved[123] */
};
static const ProtobufCFieldDescriptor
    mingdrlms__v2__e2_eesender_key_push_response__field_descriptors[2] = {
        {
            "code", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT32,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EESenderKeyPushResponse, code), NULL,
            NULL, 0,      /* flags */
            0, NULL, NULL /* reserved1,reserved2, etc */
        },
        {
            "message", 2, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING,
            0, /* quantifier_offset */
            offsetof(Mingdrlms__V2__E2EESenderKeyPushResponse, message), NULL,
            &protobuf_c_empty_string, 0, /* flags */
            0, NULL, NULL                /* reserved1,reserved2, etc */
        },
};
static const unsigned
    mingdrlms__v2__e2_eesender_key_push_response__field_indices_by_name[] = {
        0, /* field[0] = code */
        1, /* field[1] = message */
};
static const ProtobufCIntRange
    mingdrlms__v2__e2_eesender_key_push_response__number_ranges[1 + 1] = {
        {1, 0},
        {0, 2}};
const ProtobufCMessageDescriptor
    mingdrlms__v2__e2_eesender_key_push_response__descriptor = {
        PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
        "mingdrlms.v2.E2EESenderKeyPushResponse",
        "E2EESenderKeyPushResponse",
        "Mingdrlms__V2__E2EESenderKeyPushResponse",
        "mingdrlms.v2",
        sizeof(Mingdrlms__V2__E2EESenderKeyPushResponse),
        2,
        mingdrlms__v2__e2_eesender_key_push_response__field_descriptors,
        mingdrlms__v2__e2_eesender_key_push_response__field_indices_by_name,
        1,
        mingdrlms__v2__e2_eesender_key_push_response__number_ranges,
        (ProtobufCMessageInit)
            mingdrlms__v2__e2_eesender_key_push_response__init,
        NULL,
        NULL,
